...
lab4: yfs_client extent_server lock_server test-homework-5-b test-homework-5-c
lab5: yfs_client extent_server lock_server lock_tester test-homework-5-b\
	 test-homework-5-c
lab6: yfs_client extent_server lock_server test-homework-5-b test-homework-5-c
...
test-homework-5-b=test-homework-5-b.c
test-homework-5-b:  $(patsubst %.c,%.o,$(test-homework-5-b)) rpc/librpc.a

test-homework-5-c=test-homework-5-c.c
test-homework-5-c:  $(patsubst %.c,%.o,$(test-homework-5-c)) rpc/librpc.a
...
l2:
	./mklab.pl 2 0 l2 GNUmakefile $(rpclib) $(yfs_client) $(extent_server) $(lock_server) start.sh\
	 stop.sh test-homework-3.pl mkfs.sh $(hfiles2) $(hfiles1)
...
l3:
	./mklab.pl 3 0 l3 GNUmakefile  $(rpclib) $(yfs_client) $(extent_server) $(lock_server) start.sh\
	 stop.sh test-homework-3.pl mkfs.sh $(hfiles2) $(hfiles1) test-homework-4.pl
...
l4:
	./mklab.pl 4 0 l4 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client) $(rpctest) $(lock_server)\
	 $(extent_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
	 $(lock_demo) $(lock_tester) $(hfiles1) $(hfiles2) $(test-homework-5-b) $(test-homework-5-c)

l4-sol:
	./mklab.pl 4 4 l4-sol GNUmakefile test-homework-5-a.pl $(yfs_client) $(rpclib) $(rpctest) $(lock_server)\
	 $(extent_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
	 $(lock_demo) $(lock_tester) $(hfiles1) $(hfiles2) $(test-homework-5-b) $(test-homework-5-c)

l5:
	./mklab.pl 5 0 l5 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client)\
	 $(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl \
	 mkfs.sh $(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) \
	 $(test-homework-5-b) $(test-homework-5-c)

l5-sol:
	./mklab.pl 5 5 l5-sol GNUmakefile test-homework-5-a.pl $(yfs_client) $(rpclib) $(rpctest)\
	 $(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl \
	 mkfs.sh $(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) \
	 $(test-homework-5-b) $(test-homework-5-c)
...
l6:
	./mklab.pl 6 0 l6 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client) $(rpctest)\
	 $(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
	 $(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) $(test-homework-5-b) $(test-homework-5-c)

l6-sol:
	./mklab.pl 6 6 l6-sol GNUmakefile test-homework-5-a.pl $(yfs_client) $(rpclib) $(rpctest)\
	 $(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
	 $(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) $(test-homework-5-b) $(test-homework-5-c)
...
l7-sol:
	./mklab.pl 7 7 l7-sol GNUmakefile test-homework-5-a.pl $(yfs_client) $(rpclib) $(rpctest)\
		$(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
		$(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) $(test-homework-5-b) $(test-homework-5-c)\
		rsm_tester.pl $(rsm_files) $(hfiles4) $(rsm_tester)
...
l8-sol:
	./mklab.pl 8 8 l8-sol GNUmakefile test-homework-5-a.pl $(yfs_client) $(rpclib) $(rpctest)\
		$(extent_server) $(lock_server) start.sh stop.sh test-homework-3.pl mkfs.sh\
		$(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) $(test-homework-5-b) $(test-homework-5-c)\
		rsm_tester.pl $(rsm_files) $(hfiles4) rsm_client.cc $(hfiles5) $(rsm_tester)
...
.PHONY : clean
clean : 
	rm -rf rpc/rpctest rpc/*.o rpc/*.d rpc/librpc.a *.o *.d yfs_client extent_server lock_server lock_tester lock_demo rpctest test-homework-5-b test-homework-5-c rsm_tester
